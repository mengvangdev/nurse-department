...
class LaptopGridview extends StatefulWidget {
  const LaptopGridview({super.key, required this.menuIndex});

  final int menuIndex;

  @override
  State<LaptopGridview> createState() => LaptopGridviewState();
}

class LaptopGridviewState extends State<LaptopGridview> {
  @override
